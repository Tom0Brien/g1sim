...
Pipeline:
  ...
  3. Compile with MuJoCo, save tests/g1_stripped.xml (the oracle model).
...
STRIPPED = os.path.join(ROOT, "tests", "g1_stripped.xml")
...
with open(HEADER, "w") as f:
    f.write("// AUTO-GENERATED by tools/gen_model.py -- do not edit.\n")
